...
/**
 * This example shows how to use ProxyClient in order to establish a tunnel
 * through an HTTP proxy for an arbitrary protocol.
 * <p>
    ...
    public final static void main(String[] args) throws Exception {
        ...
        try {
            ...
            BufferedReader in = new BufferedReader(new InputStreamReader(
                    socket.getInputStream(), HTTP.DEF_CONTENT_CHARSET));
            String line = null;
